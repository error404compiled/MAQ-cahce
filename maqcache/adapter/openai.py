...
from maqcache.adapter.adapter import aadapt, adapt
from maqcache.adapter.base import BaseCacheLLM
from maqcache.manager.scalar_data.base import Answer, DataType
from maqcache.utils import import_openai, import_pillow
...
from maqcache.utils.token import token_counter
...
class ChatCompletion(openai.ChatCompletion, BaseCacheLLM):
    ...
    Example:
        .. code-block:: python
            ...
            # run ChatCompletion model with maqcache
...
class Completion(openai.Completion, BaseCacheLLM):
    ...
    Example:
        .. code-block:: python
            ...
            from maqcache.adapter import openai
            # run Completion model with maqcache
...
class Audio(openai.Audio):
    ...
    Example:
        .. code-block:: python
            ...
            from maqcache import cache
            from maqcache.processor.pre import get_file_bytes
            # init maqcache
            cache.init(pre_embedding_func=get_file_bytes)
            cache.set_openai_key()

            from maqcache.adapter import openai
            # run audio transcribe model with maqcache
...
class Image(openai.Image):
    ...
    Example:
        .. code-block:: python
            ...
            from maqcache.adapter import openai
            # run image generation model with maqcache
