...
from maqcache.utils import import_anthropic
...
class ChatCompletion(BaseCacheLLM):
    ...
    The interface mirrors :class:`maqcache.adapter.openai.ChatCompletion`, so that
    ...
    Example:
        .. code-block:: python
            ...
            from maqcache import cache
            from maqcache.adapter import anthropic
