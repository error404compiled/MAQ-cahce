...
from maqcache.similarity_evaluation.similarity_evaluation import SimilarityEvaluation
...
onnx = LazyImport("onnx", globals(), "maqcache.similarity_evaluation.onnx")
np = LazyImport("np", globals(), "maqcache.similarity_evaluation.np")
distance = LazyImport("simple", globals(), "maqcache.similarity_evaluation.distance")
exact_match = LazyImport(
    "exact_match", globals(), "maqcache.similarity_evaluation.exact_match"
)
kreciprocal = LazyImport(
    "kreciprocal", globals(), "maqcache.similarity_evaluation.kreciprocal"
)
cohere = LazyImport(
    "cohere", globals(), "maqcache.similarity_evaluation.cohere_rerank"
)
sequence_match = LazyImport(
    "sequence_match", globals(), "maqcache.similarity_evaluation.sequence_match"
)
time = LazyImport(
    "time", globals(), "maqcache.similarity_evaluation.time"
)
...
sbert_crossencoder = LazyImport(
    "sbert_crossencoder", globals(), "maqcache.similarity_evaluation.sbert_crossencoder"
)

jev = LazyImport(
    "jev", globals(), "maqcache.similarity_evaluation.jev"
)
