...
summarization = LazyImport(
    ...
    globals(),
    "maqcache.processor.context.summarization_context",
)
selective = LazyImport(
    "selective_context", globals(), "maqcache.processor.context.selective_context"
)
concat = LazyImport(
    "concat_context", globals(), "maqcache.processor.context.concat_context"
)
