...
class ContextProcess(metaclass=ABCMeta):
    ...
    By the way, the MAQCache will acquire more information and get a more accurate embedding vector.
    ...
    def pre_process(self, data: Dict[str, Any], **params: Dict[str, Any]) -> (Any, Any):
        """ pre-process function, it's used as the MAQCache initialization param -- pre_embedding_func.
