...
from maqcache.report import Report
from maqcache.similarity_evaluation import ExactMatchEvaluation
from maqcache.similarity_evaluation import SimilarityEvaluation
from maqcache.utils import import_openai, import_anthropic
from maqcache.utils.cache_func import cache_all
from maqcache.utils.log import maqcache_log


class Cache:
    """MAQCache core object.
    ...
    def init(
        ...
        """Pass parameters to initialize MAQCache.
