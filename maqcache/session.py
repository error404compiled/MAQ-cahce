...
from maqcache.processor.check_hit import check_hit_session
from maqcache.utils.log import maqcache_log


class Session:
    """
    Session for maqcache. Session can isolate the context of each connection, and can also filter the results after recall,
    ...
    Example:
        .. code-block:: python
            ...
            # run ChatCompletion model with maqcache on session
    ...
    def drop(self):
        ...
        maqcache_log.info("Deleting data in the session: %s.", self.name)
