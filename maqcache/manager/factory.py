...
from maqcache.manager import CacheBase, VectorBase, ObjectBase
from maqcache.manager.data_manager import SSDataManager, MapDataManager
...
def manager_factory(manager="map",
    ...
    if  scalar == "redis" and eviction_manager == "redis":
        ...
        maqcache_log.info("Since Scalar Storage and Eviction manager are both redis, "
