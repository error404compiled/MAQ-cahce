...
class MongoStorage(CacheStorage):
    ...
    By default, data is stored 'maqcache' database and following collections are created to store the data
        1. 'sessions'
        2. 'answers'
        3. 'questions'
        4. 'question_deps'
    ...
    :type host: int
    :param dbname: database name, default value 'maqcache'
    :type host: str
    :param : Mongo database name, default value 'maqcache'
    :type host: str
    ...
    Example:
        .. code-block:: python
            ...
            from maqcache.manager import CacheBase, manager_factory
