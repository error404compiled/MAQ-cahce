...
class RedisCacheStorage(CacheStorage):
    ...
    For example, for a global_key_prefix ='maqcache', keys would be constructed would look like this:
    maqcache:questions:abc123
    ...
    def __init__(
            self,
            global_key_prefix: str = "maqcache",
            host: str = "localhost",
            port: int = 6379,
            maxmemory: str = None,
            policy: str = None,
