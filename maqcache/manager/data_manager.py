...
from maqcache.manager.eviction.distributed_cache import NoOpEviction
from maqcache.manager.eviction_manager import EvictionManager
from maqcache.manager.object_data.base import ObjectBase
from maqcache.manager.scalar_data.base import (
    CacheStorage,
    CacheData,
    DataType,
    Answer,
...
from maqcache.manager.vector_data.base import VectorBase, VectorData
from maqcache.utils.error import CacheError, ParamError
...
class SSDataManager(DataManager):
    ...
    :param s: CacheStorage to manager the scalar data, it can be generated with :meth:`maqcache.manager.CacheBase`.
    :type s: CacheStorage
    :param v: VectorBase to manager the vector data, it can be generated with :meth:`maqcache.manager.VectorBase`.
    :type v:  VectorBase
    :param o: ObjectBase to manager the object data, it can be generated with :meth:`maqcache.manager.ObjectBase`.
    :type o:  ObjectBase
    :param e: EvictionBase to manager the eviction data, it can be generated with :meth:`maqcache.manager.EvictionBase`.
    :type e:  EvictionBase
    """
