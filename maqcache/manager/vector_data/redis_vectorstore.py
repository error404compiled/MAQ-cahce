...
class RedisVectorStore(VectorBase):
    ...
    :type dimension: int
    :param collection_name: the name of the index for Redis, defaults to "maqcache".
    ...
    def _check_index_exists(self, index_name: str) -> bool:
        ...
        try:
            ...
            maqcache_log.info("Index does not exist")
            return False
        maqcache_log.info("Index already exists")
        return True
