from maqcache.utils.error import NotFoundError, ParamError
...
class VectorBase:
    ...
    :param collection_name: the name of the collection for Milvus vector database, defaults to 'maqcache'.
    ...
    :type index_params: dict
    :param collection_name: the prefix of the table for PostgreSQL pgvector, defaults to 'maqcache'.
    :type collection_name: str
    ...
    def get(name, **kwargs):
        ...
        if name == "milvus":
            from maqcache.manager.vector_data.milvus import Milvus
            ...
            from maqcache.manager.vector_data.chroma import Chromadb
            ...
            from maqcache.manager.vector_data.pgvector import PGVector
            ...
            from maqcache.manager.vector_data.usearch import USearch
            ...
            from maqcache.manager.vector_data.redis_vectorstore import RedisVectorStore
            ...
            from maqcache.manager.vector_data.qdrant import QdrantVectorStore
            ...
            from maqcache.manager.vector_data.weaviate import Weaviate
            ...
            class_name = kwargs.get("class_name", "MAQCache")
